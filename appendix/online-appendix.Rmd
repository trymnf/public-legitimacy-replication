...
Figure \@ref(fig:aic-over-time) shows the monthly percentage of articles in an agency's context that also mentions the agency. We see, for instance, that the *relative* coverage of Frontex increased (in articles about refugees and migrants) during the 2015 refugee crisis. 

```{r aic-over-time, fig.cap="Monthly percentage of articles in an agency’s context mentioning the agency. With LOESS smoothed conditional mean (red line). Each point is one month.", fig.height=4}
